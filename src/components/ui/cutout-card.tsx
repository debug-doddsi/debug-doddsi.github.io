...
import {
  CutoutCardContext,
  useCutoutCard,
  type CutoutCardContextValue,
} from "./cutout-card-shared";

// Minimal stand-in for @radix-ui/react-use-controllable-state (not a
// dependency in this Vite project) - same controlled/uncontrolled contract
...
export type CutoutCardImageProps = ComponentProps<"img"> & {
  /** Absolutely fills the parent `CutoutCardMedia` (which must be `relative` with a defined block size). */
  fill?: boolean;
};
