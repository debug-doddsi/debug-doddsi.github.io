        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex justify-center gap-5 px-8 py-5">
            ...
            <button
              ...
              className="group flex flex-col items-center gap-3 px-7 py-5 rounded-xl bg-gradient-to-br from-yellow-100 via-yellow-200 to-yellow-300 border-2 border-yellow-400/60 hover:border-yellow-500/80 hover:to-yellow-400 transition-all duration-200 shadow-[inset_0_1px_2px_rgba(255,255,255,0.7),0_2px_6px_rgba(160,120,10,0.25)]"
            >
              <span className="w-10 h-10 rounded-lg bg-yellow-50/80 border border-yellow-400/50 flex items-center justify-center group-hover:bg-yellow-50 transition-colors">
          ...
          <div className="w-full px-8 pb-5">
            <button
              ...
              className="group w-full flex items-center gap-4 px-5 py-4 rounded-xl bg-gradient-to-br from-yellow-100 via-yellow-200 to-yellow-300 border-2 border-yellow-400/60 hover:border-yellow-500/80 hover:to-yellow-400 transition-all duration-200 shadow-[inset_0_1px_2px_rgba(255,255,255,0.7),0_2px_6px_rgba(160,120,10,0.25)]"
            >
              <span className="w-10 h-10 rounded-lg bg-yellow-50/80 border border-yellow-400/50 flex items-center justify-center shrink-0 group-hover:bg-yellow-50 transition-colors">
