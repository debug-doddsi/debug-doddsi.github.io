...
const INTERESTS: Interest[] = [
  ...
  { label: "Colour Palettes", emoji: "🎨", category: "professional" },
  { label: "Colour Theory", emoji: "🎨", category: "professional" },
  { label: "Component Design", emoji: "🧩", category: "professional" },
  { label: "Creative Problem Solving", emoji: "💡", category: "professional" },
  ...
  { label: "Design to Code", emoji: "💻", category: "professional" },
  ...
  { label: "Interactive Data", emoji: "📊", category: "professional" },
  { label: "Intuitive Navigation", emoji: "🗺️", category: "professional" },
  { label: "Layout Design", emoji: "📏", category: "professional" },
  { label: "Micro-interactions", emoji: "✨", category: "professional" },
  { label: "Motion Design", emoji: "🎬", category: "professional" },
  { label: "Rapid Prototyping", emoji: "⚡", category: "professional" },
  { label: "Responsive Design", emoji: "📱", category: "professional" },
  { label: "Shadcn", emoji: "✏️", category: "professional" },
  { label: "Smooth Transitions", emoji: "🌊", category: "professional" },
  ...
  { label: "Wireframing", emoji: "✏️", category: "professional" },

  // Personal
  { label: "Animal Crossing", emoji: "☂️", category: "personal" },
  { label: "Baldur's Gate 3", emoji: "🎲", category: "personal" },
  { label: "Baking", emoji: "🍰", category: "personal" },
  { label: "Cats", emoji: "🐱", category: "personal" },
  { label: "Coffee", emoji: "☕", category: "personal" },
  { label: "Cooking", emoji: "🍳", category: "personal" },
  { label: "Deftones", emoji: "🐎", category: "personal" },
