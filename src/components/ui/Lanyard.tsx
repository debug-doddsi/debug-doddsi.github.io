...
declare global {
  namespace JSX {
    interface IntrinsicElements {
      ...
      // meshline's actual prop shapes (resolution/repeat as plain arrays,
      // useMap as boolean) don't line up with what MaterialNode infers from
      // the THREE.Material base type, so this is intentionally untyped.
