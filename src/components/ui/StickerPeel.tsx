...
export function StickerPeel({
  ...
  const shadowImageStyle: CSSProperties = {
    ...imageStyle,
    filter: "url(#stickerPeelExpandAndFill)",
  };
    ...
    >
      <style
        dangerouslySetInnerHTML={{
          ...
          .sticker-peel-container:active .sticker-peel-shadow {
            clip-path: polygon(var(--sticker-start) var(--sticker-start), var(--sticker-end) var(--sticker-start), var(--sticker-end) var(--sticker-peelback-active), var(--sticker-start) var(--sticker-peelback-active)) !important;
            top: calc(-100% + 2 * var(--sticker-peelback-active) - 1px) !important;
          }
        `,
      ...
      <svg width="0" height="0">
        <defs>
          <filter id="stickerPeelPointLight">
          ...
          <filter id="stickerPeelPointLightFlipped">
          ...
          <filter id="stickerPeelExpandAndFill">
      ...
      <div
        className="sticker-peel-container relative select-none touch-none sm:touch-auto"
        ref={containerRef}
        style={{
      ...
      >
        <div className="sticker-peel-main" style={stickerMainStyle}>
          <div style={{ filter: "url(#stickerPeelPointLight)" }}>
            <img
              src={imageSrc}
              alt=""
              className="block"
        ...
        >
          <div className="sticker-peel-shadow" style={flapStyle}>
            <img
              src={imageSrc}
              alt=""
              className="block"
        ...
        <div
          className="sticker-peel-flap absolute w-full h-full left-0"
          style={flapStyle}
        >
          <div style={{ filter: "url(#stickerPeelPointLightFlipped)" }}>
            <img
              src={imageSrc}
              alt=""
              className="block"
