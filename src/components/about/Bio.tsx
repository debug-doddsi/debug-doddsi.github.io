    ...
    <div className="space-y-6">
      ...
      <GlassCard>
        <Accordion type="single" collapsible>
          <AccordionItem value="journeys" className="border-b-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="font-body text-xs text-neutral-400 leading-relaxed">
                    ...
                    worked, especially the "magical", invisible parts that power
                    everything we know and love. That curiosity has never really
                    left, and it's turned out to be a pretty useful tool.
                    <br />
                    <br />
