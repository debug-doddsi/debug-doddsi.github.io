  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <GlassCard>
          ...
          subjects: biology and physics. It was my true entrypoint into the world of engineering. As much as
          I loved and excelled in the field, I was far too squeamish around blood, bodies and hospitals to
          actually work in medicine. I flirted with the idea of working on myoelectric prostheses and robotic
          surgical platforms, but deep down I knew I'd never get over the squeamishness enough to do a job
          like that justice.
          <em> Let's just say I was grateful for being short-sighted during anatomy lectures.</em>
          <br/>
          <br/>
          Luckily, software engineering doesn't <em>usually</em> involve blood.
          At university I loved the electronics-based projects I built with friends, where we learned problem
          solving, creativity and resilience the hard way. The reward was always exhilarating, and every
          late night was worth it. I loved the process of creating something and watching my ideas come to
          life, and I knew I had to end up in research and development after graduation.
          <br/>
          <br/>
