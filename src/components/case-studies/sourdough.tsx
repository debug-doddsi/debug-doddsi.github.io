      ...
      <div className="flex flex-col gap-8">
        ...
        <div id="idea" className="scroll-mt-28">
          <GlassCard>
            ...
            <p className="font-body text-sm leading-relaxed text-neutral-400">
              ...
              same three things: when it was last fed, whether my numbers for a
              loaf actually added up, and where I was in a bake I'd started
              hours earlier. Recipe cards and notes apps weren't cutting it, so
              I built Souschef, a small companion app that remembers all of that
              for me and walks me through a bake step by step.
            </p>
          </GlassCard>
        </div>
        ...
        <div id="under-the-hood" className="scroll-mt-28">
          <GlassCard>
            ...
            <p className="font-body text-sm leading-relaxed text-neutral-400">
              An active bake is a real session, not just a checklist: it tracks
              flour, water, starter and salt mass off a fixed ratio, persists to
              local storage so a page refresh mid-bake doesn't lose my place,
              and steps through a fourteen-stage timeline with per-step timers
              for things like stretch-and-folds and the overnight proof. It's a
              genuinely small, single-purpose app, which was the point - I
              wanted something that opens straight to what I need mid-bake, with
              flour on my hands, rather than a general-purpose recipe app I have
              to dig through.
            </p>
          </GlassCard>
        </div>
        ...
        <div id="outcome" className="scroll-mt-28">
          <GlassCard>
            ...
            <p className="font-body text-sm leading-relaxed text-neutral-400">
              I use this for every bake now. I've stopped losing track of when
              my starter last got fed, and I haven't ended up with an
              over-proofed loaf from losing the thread of a bake halfway
              through. It's also been a nice low-stakes space to keep practising
              UI and product decisions on something real, outside of client
              work, where I'm both the designer and the only user.
            </p>
          </GlassCard>
        </div>
      </div>
